# Generated by Powerlevel10k configuration wizard on 2025-02-27 at 17:35 CST.
...
() {
  ...
  [[ $ZSH_VERSION == (5.<1->*|<6->.*) ]] || return
    ...
    # Desactivar envío de títulos OSC desde Powerlevel10k (importante para tmux).
  typeset -g POWERLEVEL9K_DISABLE_OSC_TITLES=true
